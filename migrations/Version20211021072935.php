 ...
 */
final class Version20211021072935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD titre VARCHAR(255) NOT NULL, ADD resume VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP titre, DROP resume');
    }
}
