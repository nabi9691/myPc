 ...
 */
final class Version20211018141933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, titre VARCHAR(255) NOT NULL, categorie_image VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, valeur VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, accessibility VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, alaune VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
